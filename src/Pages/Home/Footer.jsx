...
function Footer() {
      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.linkedin.com/in/reagan-lowe-013764290/"
  ...
  <li>
    ...
    >
      ...
      <p className="footer--content">Made with 💖 using <img src="./img/react.PNG" alt="React Logo" className="tiny-logo" /> <p className="footer--content">by Reagan</p> </p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
